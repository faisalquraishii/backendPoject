...
const asyncHandler = (requestHandler) => {   //This defines a constant asyncHandler which is assigned an arrow function. This function takes a requestHandler as an argument.
    (req, res, next) => {   /*Inside the outer function, there's another arrow function. This inner function is intended to be used as a middleware in Express.js. It takes req (request), res (response), 
